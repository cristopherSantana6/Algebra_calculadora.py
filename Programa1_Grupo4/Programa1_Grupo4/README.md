...
- Las casillas comienzan con `0`, pero al recibir el foco el `0` se selecciona automáticamente.
- El usuario puede escribir directamente el nuevo valor sin borrarlo manualmente.
- Al presionar `Enter`, el foco pasa al siguiente dato de la matriz.
- Al terminar la última casilla, `Enter` mueve el foco al botón **Resolver Sistema**.
